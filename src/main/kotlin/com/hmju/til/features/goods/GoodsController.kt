...
import com.hmju.til.features.goods.model.dto.GoodsLikeDto
import com.hmju.til.features.goods.model.vo.GoodsLikeVO
...
class GoodsController @Autowired constructor(
    ...
    @PostMapping("/like")
    fun postLike(
        @RequestBody body: GoodsLikeVO
    ): JSendResponse<GoodsLikeDto, JSendMeta> {
        return JSendResponse.Builder<GoodsLikeDto, JSendMeta>()
            .setPayload(GoodsLikeDto(body.id))
            .build()
    }
